...
{ 
    ...
    $uploaded_file = $_FILES['room_pic']["name"];
    ...
    $f1 = $_POST['roomname']. $file_ext;
			
    move_uploaded_file($_FILES["room_pic"]["tmp_name"],"../uploads/" . $f1);

    $result=$user->add_room($roomname, $room_qnty, $no_bed, $bedtype,$facility,$price,$f1);
    if($result)
    {
        ...
        <div class="well">
            ...
            <form action="" method="post" name="room_category" enctype="multipart/form-data">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label for="room_pic">Room image:</label>
                    <input type="file" class="form-control" name="room_pic">
                </div>
