...
$result=mysqli_query($user->db,$query) or 
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="carts.php">
                            <button type="button" class="btn btn-green"> Cart</button>
                        </a>
                    </li>
                    <li>
        ...
        if($result)
        {
            if(mysqli_num_rows($result) > 0)
            {
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo '<td>
                    <input class="inp" type="number" name="qty" class="form-control" value="1" required>
