    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <form action="" method="post" name="login">
                ...
                <button type="submit" name="submit" value="Login" onclick="return(submitlogin());" class="btn btn-lg btn-primary btn-block">Submit</button>
                ...
                <?php if(isset($_REQUEST[ 'submit'])) { extract($_REQUEST); $login=$user->check_logins($emailusername, $password); 
                    if($login) { echo "<script>location='../staff.php'</script>"; } 
                else{?>
