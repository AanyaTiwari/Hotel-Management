...
//               ********************************************** Show Room Category***********************
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                            ...
                            &nbsp;&nbsp;
                            <a href='edit_all_rooms.php?id=".$row['room_id']."'><button class='btn btn-primary button'>Edit</button></a>
                            &nbsp;&nbsp;
                            <a href='cancel.php?id=".$row['room_id']."'><button class='btn btn-primary button'>Cancel</button></a>
                            </div>
            ...
            {
                echo "<center><p style='margin-top:100px'><span style='color:red'>NO Booking</span></p></center>";
            }
        }
        else
        {
